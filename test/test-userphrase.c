...
void test_userphrase_auto_learn_with_symbol()
{
    ...
    //ok(has_userphrase(ctx, bopomofo_3, NULL) == 1, "`%s' shall not be in userphrase", bopomofo_3);
    ok(has_userphrase(ctx, bopomofo_3, NULL) == 1, "`%s' shall be in userphrase", bopomofo_3);
